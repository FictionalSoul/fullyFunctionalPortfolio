...
// We have used svgr.com to convert our svg image code to convert it into react code.

// We have made ccircular text image by using 1. Go to canva.com enter text choOSE Font properties and then use effects made it circular
//2. Downloaded it then gone to ERASE.BG to erase the background of image 
//3. Gone to Adobe Express to convert image into svg code 
...
export const HackerRank = (className, ...rest) => (
 ...
 export const LeetCode = (className,...rest) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="16px" height ="16px" viewBox="0 0 24 24" className={`w-full h-auto ${className}`} {...rest}>
      <path
        fill="#B3B1B0"
